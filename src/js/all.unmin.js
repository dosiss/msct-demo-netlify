...
document.addEventListener("DOMContentLoaded", function() {
  const slider = document.querySelector(".big-partners__wrap");
     ...
     slider.addEventListener("mouseup", (e) => {
       isDown = false;
       const elements = document.querySelectorAll(".partners__list a");
       if(isDragged){
...
document.addEventListener("DOMContentLoaded", function() {
  const slider = document.querySelector(".regular-partners__wrap");
     const preventClick = (e) => {
       e.preventDefault();
       e.stopImmediatePropagation();
     }
