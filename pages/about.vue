  ...
  <div>
    ...
    <div id="about">
      <div class="container container-narrow">
        <h1>{{$t('About Us')}}</h1>
        <article>
          <nuxt-img src="/images/img_team3.jpg" sizes="sm:480px md:998px" alt="" />
