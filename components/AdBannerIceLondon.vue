...
<section id="ad-banner">
  <div class="ad-banner__wrap">
    <a href="https://www.igblive.com/" target="_blank" title="https://www.igblive.com/">
      <div class="ad-banner__inner">
        <nuxt-img src="images/igblive-logo-2.png" class="ad-banner__logo-new"  alt="iGBLive London" />
        <div class="ad-banner__text">
          <div class="ad-banner__text-left">
            <div class="ad-banner__company">Mascot Gaming</div>
            <div class="ad-banner__stand">Booth V70</div>
          </div>
          <div class="ad-banner__text-right">
            <div class="ad-banner__date">02 – 03 July 2025</div>
            <div class="ad-banner__place">London</div>
          </div>
        </div>
        <nuxt-img src="images/img-adbanner-decor20-dsktop.png" sizes="sm:200px md:420px lg:450px" class="ad-banner__decor decor-african decor-mobile"  alt="" />
        <nuxt-img src="images/img-adbanner-decor20-dsktop.png" sizes="sm:200px md:520px lg:450px" class="ad-banner__decor decor-african decor-dsktop"  alt="" />
      </div>
    </a>
  </div>
</section>
